...
```
gui/src/lib/api/bindings.ts   GENERATED by `make ts`. 77 types. Never hand-edit.
...
the line. Every derivation this slice was tempted into became a line in
[`../docs/prompts/17-derived-facts.md`](../docs/prompts/17-derived-facts.md)
instead. Keep doing that: the prompt file is the record of what item 17 owes.

**3. Types are generated, never hand-written.** 77 types come from Rust via
